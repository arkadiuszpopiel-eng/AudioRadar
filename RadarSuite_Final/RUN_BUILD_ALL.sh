...
# Get executable size
EXE_SIZE=$(stat -f%z "$APP_DIR/RadarSuite_Final" 2>/dev/null || stat -c%s "$APP_DIR/RadarSuite_Final" 2>/dev/null)
...
echo "  - Executable File: RadarSuite_Final"

#!/bin/bash
# ============================================================================
# RadarSuite Linux V4.2 - Linux Build Script
...
# Set version - V4.2 synchronized with Windows
VERSION="v4.2.0"
PLATFORM="Linux64"
...
echo ""
echo "========================================================================"
echo "  RadarSuite Linux V4.2 - Build System"
echo "  Building Linux standalone executable with PyInstaller"
echo "  Platform: Linux x64 ONLY"
echo "  Synchronized with Windows V4.2"
echo "========================================================================"
log "============================================================"
log "BUILD STARTED - RadarSuite Linux V4.2"
log "============================================================"
log "Version: $VERSION"
...
echo "========================================================================"
echo "  RadarSuite Linux V4.2 - Dedicated Linux Build"
echo "  This version builds ONLY for Linux x64"
echo "  Features synchronized with Windows V4.2:"
echo "    - Shot detection (shot.py)"
echo "    - ML detection (machine.py)"
echo "    - Spectral analysis (spectral.py)"
echo "    - Confidence system (confidence.py)"
echo "    - Enhanced target tracking"
echo "========================================================================"
echo ""

echo -e "${YELLOW}[INFO] This is the LINUX-ONLY version${NC}"
echo "   Windows builds: Use RadarSuite_Windows_V4.2 directory"
...
for cmd in python3.11 python3 python; do
    if command -v $cmd &> /dev/null; then
        ...
        if [[ $VERSION_OUTPUT == *"Python 3.11"* ]] || [[ $VERSION_OUTPUT == *"Python 3.12"* ]]; then
            PYTHON_CMD=$cmd
...
# Get executable size
EXE_SIZE=$(stat -c%s "$APP_DIR/RadarSuite_Linux" 2>/dev/null || stat -f%z "$APP_DIR/RadarSuite_Linux" 2>/dev/null)
...
ZIP_NAME="RadarSuite_Linux_V4.2_${VERSION}_Linux-x64_${TIMESTAMP}.zip"
...
if ! command -v zip &> /dev/null; then
    ...
    if [ $? -ne 0 ]; then
        ...
        # Get ZIP size
        ZIP_SIZE=$(stat -c%s "dist/$ZIP_NAME" 2>/dev/null || stat -f%z "dist/$ZIP_NAME" 2>/dev/null)
...
echo "  RadarSuite Linux V4.2 - Synchronized with Windows V4.2"
echo "========================================================================"
echo ""
...
echo ""
echo "New V4.2 Features (synchronized with Windows):"
echo "  - Shot detection module"
echo "  - ML-based detection"
echo "  - Spectral analysis"
echo "  - Confidence scoring"
echo "  - Enhanced target tracking"
echo "  - 5.1/7.1 surround sound support"
echo ""
echo "Output:"
...
log "============================================================"
log "BUILD COMPLETED SUCCESSFULLY - RadarSuite Linux V4.2"
log "============================================================"
echo ""

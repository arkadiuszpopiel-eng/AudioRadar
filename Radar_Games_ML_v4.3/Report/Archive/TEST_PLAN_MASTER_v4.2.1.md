...
**Software Version**: Radar Games ML v4.2.1-k0003
**Date**: 2025-12-09
...
**Radar Games ML Windows V4.2.1** - Professional real-time audio detection and spatial tracking system for gaming (ARC Raiders). PyQt5-based desktop application with advanced ML training capabilities, multi-threaded audio processing, 3D radar visualization, and custom model training.
...
**Scope**: If Radar Games ML exposes APIs (internal or external)
  ...
  deploy:
    ...
    - name: Build executable
      run: |
        ...
        pyinstaller Radar Games ML_Windows_V4.2.spec
    ...
    - name: Upload artifact
      uses: actions/upload-artifact@v3
      with:
        name: Radar Games ML-Windows-v4.2.1-k0003
        path: dist/
```
...
```markdown
# Radar Games ML v4.2.1-k0003 Test Execution Report

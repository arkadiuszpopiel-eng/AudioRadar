"""
Radar Games ML v3.5.0 - Translations Module
...
TRANSLATIONS = {
    'en': {
        # Application
        'app_title': 'Radar Games ML Final',
        'language': 'Language:',
        ...
        'ml_training_how_to_fix': 'How to Fix',
        'ml_training_step1': '1. Open terminal/command prompt',
        'ml_training_step2': '2. Run this command:',
        'ml_training_step3': '3. Restart the application',
        'ml_training_copy_command': 'Copy Command',
        'ml_training_show_details': 'Show Technical Details',
        'ml_training_hide_details': 'Hide Technical Details',
        'ml_training_command_copied': 'Command copied to clipboard!',
    ...
    'pl': {
        ...
        'ml_training_how_to_fix': 'Jak naprawić',
        'ml_training_step1': '1. Otwórz terminal/wiersz poleceń',
        'ml_training_step2': '2. Uruchom tę komendę:',
        'ml_training_step3': '3. Uruchom ponownie aplikację',
        'ml_training_copy_command': 'Kopiuj Komendę',
        'ml_training_show_details': 'Pokaż Szczegóły Techniczne',
        'ml_training_hide_details': 'Ukryj Szczegóły Techniczne',
        'ml_training_command_copied': 'Komenda skopiowana do schowka!',

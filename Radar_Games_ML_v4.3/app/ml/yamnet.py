"""
Radar Games ML v4.2.0 - YAMNet Audio Classifier Wrapper
...
Relevant classes for Radar Games ML:
...
# Map YAMNet class IDs to Radar Games ML detection categories
YAMNET_CLASS_MAP = {
    # Gunshots / Weapons
...
class YAMNetDetector:
    ...
    def _aggregate_to_categories(self, class_probs: np.ndarray) -> Dict[str, float]:
        """
        Aggregate YAMNet class probabilities to Radar Games ML categories.

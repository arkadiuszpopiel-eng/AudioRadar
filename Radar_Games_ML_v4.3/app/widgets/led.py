"""
Radar Games ML v3.5.0 - Led Widgets
"""
...
from app.core import log, tr, VERSION, TOAST_DURATION_MS, TOAST_MAX_COUNT
...
class DetachableLedWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle(f"{tr('led_alert')} - Radar Games ML {VERSION}")

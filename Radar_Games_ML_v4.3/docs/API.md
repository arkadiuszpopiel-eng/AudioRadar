# Radar Games ML V4.2.1 - API Documentation

## Architecture Overview

Radar Games ML is a real-time audio detection and spatial tracking system built with PyQt5. The application uses a modular architecture with clear separation of concerns:

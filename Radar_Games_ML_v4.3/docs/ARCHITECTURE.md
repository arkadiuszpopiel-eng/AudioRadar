# Architecture - Radar Games ML V4.2.0
...
Radar Games ML follows a **layered architecture** with clear separation of concerns:
...
**Storage:** `%APPDATA%\Radar Games ML\config.json`
...
**Radar Games ML V4.2.0** - Well-architected audio intelligence system.

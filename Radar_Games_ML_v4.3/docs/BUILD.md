# Build Guide - Radar Games ML V4.2.0
...
Radar Games ML uses **PyInstaller 6.0+** to create standalone executables for Windows.
...
**Usage:**
```cmd
cd AudioRadar\Radar Games ML_Windows_V4.2
...
```
==========================================
Radar Games ML V4.2.0 - Windows Build Script
==========================================
...
Building Radar Games ML_V4.2.0_win.exe...
✓ Build complete

Step 7/7: Packaging to ZIP...
✓ Package created: Radar Games ML_V4.2.0_Windows-x64_20251201_143052.zip

==========================================
BUILD SUCCESS!
==========================================
Output: dist/Radar Games ML_V4.2.0_Windows-x64_20251201_143052.zip
Size: 125.3 MB
```
...
**After build:**
```
Radar Games ML_Windows_V4.2/
├── build/                          (temporary build files - safe to delete)
├── dist/
│   ├── Radar Games ML_V4.2.0_win/      (extracted executable directory)
│   │   ├── Radar Games ML_V4.2.0_win.exe
│   │   ├── *.dll (Qt, Python runtime)
│   │   └── ... (all dependencies)
│   └── Radar Games ML_V4.2.0_Windows-x64_20251201_143052.zip
└── Radar Games ML_V4.2.0_win.spec      (PyInstaller spec file)
```
...
**Location:** `build_tools/Radar Games ML_V4.2.0_win.spec`
...
exe = EXE(
    ...
    name='Radar Games ML_V4.2.0_win',
    debug=False,
...
**Edit:** `build_tools/Radar Games ML_V4.2.0_win.spec`

```python
# Change all occurrences
name='Radar Games ML_V4.3.0_win',  # Update version
```
...
```cmd
pyinstaller build_tools/Radar Games ML_V4.2.0_win.spec
```
...
$zipName = "Radar Games ML_V4.2.0_Windows-x64_$timestamp.zip"
Compress-Archive -Path dist\Radar Games ML_V4.2.0_win -DestinationPath dist\$zipName
```
...
```
Radar Games ML_V4.2.0_win/
├── Radar Games ML_V4.2.0_win.exe       (main executable)
...
**Distribute:**
- `Radar Games ML_V4.2.0_Windows-x64_YYYYMMDD_HHMMSS.zip`

**Instructions for users:**
```
1. Extract ZIP to C:\Radar Games ML\
2. Run Radar Games ML_V4.2.0_win.exe
...
```cmd
cd dist\Radar Games ML_V4.2.0_win
Radar Games ML_V4.2.0_win.exe
```
...
```cmd
dumpbin /dependents Radar Games ML_V4.2.0_win.exe
```
...
**Radar Games ML V4.2.0** - Build standalone executables with ease.

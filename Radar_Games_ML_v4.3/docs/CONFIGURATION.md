# Configuration Reference - Radar Games ML V4.2.0
...
**Location:** `%APPDATA%\Radar Games ML\config.json`
...
**Radar Games ML V4.2.0** - Optimized configuration for peak performance.

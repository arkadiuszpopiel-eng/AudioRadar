# Installation Guide - Radar Games ML V4.2.0
...
**Important:** Radar Games ML requires Python 3.11. Newer versions (3.12+) may have compatibility issues with some dependencies.
...
3. Radar Games ML will auto-detect and optimize settings
...
**Note:** GPU acceleration is optional. Radar Games ML runs fine on CPU-only systems.
...
On first launch, Radar Games ML will:
...
2. Download: `Radar Games ML_V4.2.0_Windows-x64.zip`
3. Extract to: `C:\Radar Games ML\`
...
3. Radar Games ML auto-configures loopback mode
...
```
%APPDATA%\Radar Games ML\config.json
```
...
**Solution:**
1. Launch game first, then Radar Games ML
...
rmdir /s "%APPDATA%\Radar Games ML"
...
**Radar Games ML V4.2.0** - Installation complete! Ready for tactical audio intelligence.
